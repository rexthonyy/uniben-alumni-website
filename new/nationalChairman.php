...
<head>
	...
	<title>National Chairman UNIBEN Alumni</title>
</head>
		...
		<div class="rex-overflow-auto">
			...
			<div class="rex-pad16px">
				<div class="rex-center-text rex-background-gray rex-height-200px">
					<h1 class="rex-center-relative-div-vertical">National Chairman</h1>
				</div>
			</div>
			...
			<div class="rex-background-white rex-pad16px">
				...
				<div>
					<img src="images/pics/chairman.jpg" class="rex-float-left rex-width-200px rex-height-200px rex-mr-8px rex-mb-8px" />
					...
					<p class="rex-mt-32px rex-line-height-normal rex-fs-normal">
